    ...
    <div className={styles.container}>
      <div className={styles.wrapper}>
        <div className={styles.header}>
          <h1 className={styles.title}>סילבוס הקורסים</h1>
        </div>
      ...
      <div className={styles.row}>
          <Bonus 
            title="יחס אישי" 
            description="תשארי איתי עד הערב אם צריך - העיקר שתצאי ממני מושלמת. אצלי לא מוותרים על אף ריס, אפילו אם זה אומר להתעכב שעתיים נוספות." 
            icon={alone}
          />
          <Bonus 
            title="העצמה ובטחון" 
            description="מעבר ללימוד הטכניקה, אני מעניקה לך את הכלים להצליח כעצמאית בתחום. את תצאי מכאן עם הביטחון לבנות את העסק שלך והעתיד שלך." 
            icon={female}
          />
        </div>
        ...
        <div className={styles.row}>
          <Bonus 
            ...
            description="גם אחרי הקורס - את לא לבד! מענה מלא לכל שאלה, תמיכה בהתפתחות המקצועית שלך וליווי אישי עד שתרגישי בטוחה במאה אחוז." 
            icon={answers}
          />
          <Bonus 
