    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.description}>
            דווקא האכזבות האלה הפכו להיות ההשראה הכי גדולה שלי. הבנתי בדיוק מה חסר בתעשייה, ומה אני הולכת לעשות אחרת! היום, עם 8 שנות ניסיון מאחוריי, יצרתי שיטת לימוד שהיא בדיוק מה שחיפשתי בעצמי - שילוב מנצח של מקצועיות, עם המון סבלנות (מבחינתי תישארי איתי עד הערב, העיקר שתצאי פרפקט!). ואת יודעת מה הכי חשוב? הליווי שלי לא נגמר כשהקורס נגמר. כי בשבילי, כל תלמידה שמצליחה זו עוד הוכחה שאפשר לבנות קריירה מטורפת בתחום, להיות עצמאית, ולשלוט בלוח הזמנים שלך. השם שלי מונח כאן, וההצלחה של כל תלמידה שלי היא לגמרי גם הצלחה שלי!
          </p>
        </div>
      </div>
      <Works/>
